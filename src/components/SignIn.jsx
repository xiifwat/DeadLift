      ...
      <div className="signin-card">
        ...
        <div>
          ...
          <p className="signin-tagline">
            Tasks ranked by what matters most —<br />priority and how close the deadline is.
          </p>
        </div>
        ...
        <span className="signin-footnote">Your tasks stay private to your account.</span>
      </div>
    </div>
  )
}
